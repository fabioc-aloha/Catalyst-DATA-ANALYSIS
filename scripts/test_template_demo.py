...
DATASET_NAME = "DBA710_DEMO"  # Update this
SPSS_FILENAME = "DBA 710 Multiple Stores.sav"     # Update this
KEY_VARIABLES = ['BLDGAGE', 'ROISCORE', 'CUSTSCORE']  # Update these
GROUPING_VARIABLE = 'SETTING'     # Update if doing group comparisons
OUTCOME_VARIABLE = 'CUSTSCORE'    # Update for t-tests

# Business context customization
ANALYSIS_TITLE = "Customer Experience Demo Analysis"
BUSINESS_DOMAIN = "Retail Analytics"
KEY_INSIGHTS_TEMPLATE = [
    "ROI strongly correlates with customer satisfaction",
    "Building age impacts customer experience", 
    "Store setting affects satisfaction levels"
]
